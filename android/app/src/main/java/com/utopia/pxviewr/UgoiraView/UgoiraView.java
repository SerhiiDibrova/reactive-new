...
public class UgoiraViewManager extends SimpleViewManager<UgoiraView> {
    ...
    public void setImageScaleType(UgoiraView view, String resizeMode) {
        view.setImageScaleType(resizeMode);
    }

    @ReactProp(name = "pauseAnimation")
    public void pauseAnimation(UgoiraView view) {
        view.pauseAnimation();
    }

    @ReactProp(name = "resumeAnimation")
    public void resumeAnimation(UgoiraView view) {
                            ...
                            Glide.with(context).asBitmap()
                                    ...
                                    .into(new SimpleTarget<Bitmap>(width, height) {
                                        ...
                                        public void onLoadFailed(@Nullable Drawable errorDrawable) {
                                            e.onError(new Exception("Image load failed"));
                                        }
                                    });
                        }
                    });
